...
//                .images()
        ...
        ProductRequestDto motherboardAsus = ProductRequestDto.builder()
                ...
                .brand("Asus")
                .model("Prime H610m-k")
                .images(Collections.singletonList("https://ecommerce.spartan.images.s3.us-east-2.amazonaws.com/1677790263233Board_Asus_1.png"))
                .category("Motherboard")
                .subCategory("Intel")
        ...
        ProductRequestDto tower1 = ProductRequestDto.builder()
                ...
                .images(Collections.singletonList("https://ecommerce.spartan.images.s3.us-east-2.amazonaws.com/1677790441182Gabinete%20Gamer%201.png"))
                .category("Gabinete")
                .subCategory("Gamer")
